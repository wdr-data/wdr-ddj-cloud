...
CHART_ID = os.environ.get("NASA_WALDBRANDDATEN_MAUI_CHART_ID")

CURRENT_DIR = Path(__file__).parent
NASA_API_BASE_URL = "https://firms.modaps.eosdis.nasa.gov/api"
INSTRUMENT = "VIIRS_SNPP_NRT"

MAP_EXTENT_NW = [21.437756, -157.451087]
MAP_EXTENT_SE = [20.321983, -155.779522]
...
def run():
    ...
    # Upload the data
    upload_dataframe(df, "nasa_waldbranddaten_maui/nasa_data.csv")
